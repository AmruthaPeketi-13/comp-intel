...
async function main() {
  console.log('Seeding guaranteed data...')
  
  const data = []

  // Guarantee at least 1 entry for EVERY company and EVERY level
  ...
  console.log('Seeding complete! Added ' + data.length + ' guaranteed rows.')
}
